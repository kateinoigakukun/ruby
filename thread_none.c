...
static int native_thread_init_stack(rb_thread_t *th) { return 0; /* success */ }
...
#define ubf_select 0
inline static void ubf_wakeup_all_threads(void) { return; }
inline static int ubf_threads_empty(void) { return 1; /* true */ }
inline static void ubf_list_atfork() {}
inline static void ubf_timer_disarm(void) {}

// No timer thread because thread switching won't happen
#define TIMER_THREAD_CREATED_P() (1)
inline static void rb_thread_create_timer_thread(void) {}
void rb_thread_wakeup_timer_thread(int sig) {}
inline static int native_stop_timer_thread(void) { return 1; /* success */ }
inline static void native_reset_timer_thread(void) {}

// Do nothing for thread naming
inline static void native_set_thread_name(rb_thread_t *th) {}
inline static void native_set_another_thread_name(rb_nativethread_id_t thread_id, VALUE name) {}
...
int rb_reserved_fd_p(int fd) { return 0; /* not reserved */ }

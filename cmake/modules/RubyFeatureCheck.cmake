...
macro(ruby_check_funcs missing_srcs_out)
  ruby_replace_func(strlcpy "${missing_srcs_out}")
  ruby_replace_func(strlcat "${missing_srcs_out}")
  ruby_replace_func(setproctitle "${missing_srcs_out}")
endmacro()

...
#ifndef HAVE_GETEUID
RUBY_EXTERN uid_t geteuid(void);
#endif

#ifndef HAVE_GETUID
RUBY_EXTERN uid_t getuid(void);
#endif

#ifndef HAVE_GETEGID
RUBY_EXTERN int getegid(void);
#endif

#ifndef HAVE_GETGID
RUBY_EXTERN int getgid(void);
#endif
...
#ifndef HAVE_GETPPID
RUBY_EXTERN int getppid(void);
#endif

#ifndef HAVE_UMASK
RUBY_EXTERN int umask(int);
#endif

#ifndef HAVE_CHMOD
RUBY_EXTERN int chmod(const char *, int);
#endif

#ifndef HAVE_CHOWN
RUBY_EXTERN int chown(const char *, int, int);
#endif
